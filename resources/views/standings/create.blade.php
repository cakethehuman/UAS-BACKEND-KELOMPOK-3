                ...
                <div class="mb-4">
                    ...
                    <select name="team_id" id="team_id" class="w-full rounded border p-2" required>
                        <div class="flex justify-center items-center text-white">          
                            <h1 class="text-blue-300 font-bold text-3xl w-70 h-15 py-2 text-center 
                            border-2 bg-gray-300 border-mavs-navy rounded-full m-5 shadow-lg shadow-mavs-navy">
                                <option class = "text-white" value="">-- Pilih Tim --</option>
                            </h1>
                        </div>
                        @foreach($teams as $team)
                            <option class = "text-white" value="{{ $team->id }}">{{ $team->name }}</option>
                        @endforeach
                    </select>
                </div>
